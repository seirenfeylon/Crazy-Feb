...
export function SignUpPage() {
  ...
  const { signUp, signInWithGoogle, configured, isMock } = useAuth();
    ...
    <AuthShell>
      ...
      {isMock && (
        <div className="mt-4 flex items-start gap-2 rounded-xl bg-gold-50 dark:bg-gold-950/20 border border-gold-200/40 p-3 text-xs text-gold-700 dark:text-gold-300">
          ...
          <span><strong>Demo Mode Active:</strong> Any account credentials registered here will be saved and persistent in localStorage.</span>
        </div>
      )}
